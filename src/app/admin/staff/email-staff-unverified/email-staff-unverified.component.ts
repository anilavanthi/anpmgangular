...
@Component({
  selector: 'app-email-staff-unverified',
  templateUrl: './email-staff-unverified.component.html',
  styleUrls: ['./email-staff-unverified.component.scss']
})
export class EmailStaffUnverifiedComponent
