...
@Component({
  selector: 'app-banned-agents',
  templateUrl: './banned-agents.component.html',
  styleUrls: ['./banned-agents.component.scss']
})
export class BannedAgentsComponent
